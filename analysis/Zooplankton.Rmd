...
Nous voyons ici que la taile en fonction de l'aire est très variable en fonction de l'espèce.
...
Nous constatons ici que la taille varie énormement en fonction de l'espèce.
...
La compacité en fonction de la transparence est très variable même au sein de la même classe : elle peut être soit très dispersé comme pour les annelides ou les malacotracea, soit très dense comme les calanoides ou les décapodes.
